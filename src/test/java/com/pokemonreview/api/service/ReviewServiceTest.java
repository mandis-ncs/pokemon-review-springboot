...
public class ReviewServiceTest {
    ...
    @Test
    @DisplayName("Should create a review and return a dto")
    ...
    @Test
    @DisplayName("Should find reviews by pokemon id and return a dto")
    public void findReviewByPokemonId() {
    ...
    @Test
    @DisplayName("Should find review by id and return a dto")
    ...
    @Test
    @DisplayName("Should update a pokemon and return a dto")
